...
//  MyoVis
//
//  Created by Panagiotis Diakas on 20.08.19.
...
class Stage2ViewController: UIViewController {
    ...
    @IBAction func nextBtnPressed(_ sender: Any) {
        ...
        self.performSegue(withIdentifier: "showStage3", sender: self)
    }
    
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let destination = segue.destination as? Stage3ViewController{
